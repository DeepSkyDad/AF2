...
namespace ASCOM.DeepSkyDad.AF2
{
    //
    // Your driver's DeviceID is ASCOM.DeepSkyDad.AF2.Focuser
    //
    // The Guid attribute sets the CLSID for ASCOM.DeepSkyDad.AF2.Focuser
    ...
    public partial class Focuser : IFocuserV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.DeepSkyDad.AF2.Focuser";
        // TODO Change the descriptive string for your driver then remove this line
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "ASCOM Deep Sky Dad AF2";

        private static string fimrwareVersion = "Board=DeepSkyDad.AF2, Version=1.0";
        ...
        public Focuser()
        {
            ...
            tl = new TraceLogger("", "DeepSkyDad.AF2");
            tl.Enabled = traceState;

            tl.LogMessage("Telescope", "Starting initialisation");

            tls = new TraceLogger("", "DeepSkyDad.AF2.Serial");
        ...
        public bool Connected
        {
            ...
            set
            {
                ...
                if (value)
                {
                    ...
                    try
                    {
                        actualFirmwareVersion = CommandString("GFRL");
                    }
                    catch (Exception)
                    {
                        //retry
                    ...
                    if (!actualFirmwareVersion.StartsWith(fimrwareVersion))
                        throw new ASCOM.DriverException($"Invalid firmware version - required: {fimrwareVersion}.X, installed {actualFirmwareVersion}");
                    ...
                    CommandString($"SSPD{sm}");
                    CommandString($"SCLM{coilsModeInt}");
                    ...
                    CommandString($"SIDC{idleCoilsTimeout}");
                    CommandString("SIDE180000");
                    CommandString($"SCMV{currentMove}");
                    CommandString($"SCHD{currentHold}");
                }
                else
                {
                    CommandString($"SCLM0");
        ...
        public string DriverInfo
        {
            get
            {
                ...
                string driverInfo = "ASCOM DSD AF2 driver. Version: " + String.Format(CultureInfo.InvariantCulture, "{0}.{1}", version.Major, version.Minor);
        ...
        {
            //if (TempComp)
            //    throw new InvalidOperationException("Temperature compensation turned on");
